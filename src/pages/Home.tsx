...
import { homeMeta } from '../data/pageMeta';
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-32 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="absolute -bottom-6 -right-6 glass p-5 rounded-[20px] max-w-[160px] hidden md:block shadow-2xl border-white/50"
              >
                <div className="w-10 h-10 rounded-xl bg-brand-teal/10 flex items-center justify-center mb-3">
                  <TrendingDown className="w-5 h-5 text-brand-teal" />
                </div>
                <h4 className="text-sm font-bold text-brand-dark mb-1 tracking-tight">Lower Bills, <br />Higher Value.</h4>
                <p className="text-[10px] text-brand-dark/60 leading-tight">Our systems are optimized for maximum energy harvest even in low light conditions.</p>
              </motion.div>
            </div>
